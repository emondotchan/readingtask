...
export interface DailyTaskRunSnapshot {
  task_id: string;
  date: string;
  run_state: "idle" | "running" | "paused" | "completed" | "monthly-completed" | "error";
  processed_count: number;
  requested_count: number;
  items: TaskItemResult[];
...
export interface BatchRunDailyTasksResponse {
...
export interface DailyTask {
  ...
  is_locked: boolean;
  run_status: "not_started" | "running" | "paused" | "completed";
  shopcodes: string[];
}
